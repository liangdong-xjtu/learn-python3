...
<time datetime="2017-08-28T00:00:00+00:00">28 Aug. &ndash; 02 Sept. <span class="say-no-more"> 2017</span></time>
...
<time datetime="2017-09-02T00:00:00+00:00">02 Sept. &ndash; 04 Sept. <span class="say-no-more"> 2017</span></time>
...
<time datetime="2017-09-21T00:00:00+00:00">21 Sept. &ndash; 25 Sept. <span class="say-no-more"> 2017</span></time>
...
class MyHTMLParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'time':
            MyHTMLParser._infos[-1]['time'] = attrs[0][1]   # -1 下标表示放到list的最后，这样结合append就可以支持按顺序输出
